...
const char* ssid = "kkkkkk";       //wifi name
const char* password = "12345678901";       //password
char auth[] = "zmfabVLa2geBuZsy1wp-7FvwY8_t7JlD";          //Auth Code sent by Blynk
...
//Blynk.setProperty(V2, "url", "http://"+local_IP+"/capture?_cb="+(String)randomNum); //ESP32 CAM 2
...
void setup() {
  ...
  Blynk.begin(auth, ssid, password,"www.lnwqh.xyz",7070);
}
